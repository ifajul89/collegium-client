...
const CollegePage = () => {
  ...
  return (
    <div className="fitting space-top-bottom flex flex-col md:flex-row gap-5">
      <img className="rounded-3xl md:w-1/2" src={image} alt="" />
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {events.map((oneEvent, index) => {
              return (
                <div
                  className="p-3 md:text-xl bg-gray-100 hover:bg-gray-200 border rounded-xl border-gray-300 duration-300 text-gray-800"
                  key={index}
                >
